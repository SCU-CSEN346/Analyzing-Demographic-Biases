...
def main():
    ...
    results_df.to_csv("upper_bound_results_matrix_asap.csv", index=False)
    print("\nAll upper bound training complete! Results saved to 'upper_bound_results_matrix_asap.csv'.")
    print(results_df)
